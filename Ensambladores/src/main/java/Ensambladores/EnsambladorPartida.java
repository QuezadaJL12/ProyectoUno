...
public class EnsambladorPartida {
    ...
    public static EstadoPartidaDTO mapear(Partida partida, String idJugadorSolicitante) {
        ...
        if (partida.hayGanador()) {
            ...
            // NUEVO: Agregamos el mapa de puntos al DTO
            dto.setPuntuaciones(partida.calcularPuntosFinales());
        }
...
rivales.add(new JugadorResumenDTO(j.getId(), j.getNombre(), j.getMano().size(), j.getAvatar()));
